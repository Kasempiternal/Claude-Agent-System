...
Cannot access memory files.
Creating fresh memory structure...
...
### Document Errors
Save to `ClaudeFiles/memory/CLAUDE-troubleshooting.md`:
- Error type
- Context when occurred
- Solution applied
- Success/failure
...
- `ClaudeFiles/memory/` for error logging