...
Store detected configuration in `.claude/files/memory/CLAUDE-build-config.md`:

```markdown
# Project Build Configuration

Last Detected: [timestamp]
Source Files: Makefile, .gitlab-ci.yml
...
- Force grid wrap: 0
- Use parentheses: enabled

### Linting (flake8)
- Ignored rules: E501, E203, W503
- Max line length: 100
...
1. Use 100 character line limit
2. Sort imports with black profile
3. Use vertical hanging indent for multi-line imports
4. Add trailing commas in multi-line structures
5. Include type hints for public functions
6. Ignore E501 (line too long) in edge cases
7. Exclude models/ directory from checks
```
