...
Save analysis to: `~/.claude/temp/project-analysis-[timestamp].md`

**IMPORTANT**: This is a temporary analysis file for the current workflow. Permanent documentation only created when user explicitly requests it.
