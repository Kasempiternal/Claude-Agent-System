...
## ⚠️ File Policy
Temporary workflow files go to `~/.claude/temp/` and are deleted after workflow completion.
...
7. **Finalization**
   ...
   - Generate completion report (output directly)
   - Clean up any temp files in ~/.claude/temp/
...
### Cycle Summary Report (Output Directly)
```json
{
