...
Save architecture to: `~/.claude/temp/standards-framework-[timestamp].md`

**IMPORTANT**: This is a temporary working file. User must explicitly approve creation of permanent standards documentation in their repository.
...
### Standards Documentation Structure (Temporary Working Location)
```
...
**NOTE**: These files are created in temp location. User must explicitly request and approve moving them to their project repository.
